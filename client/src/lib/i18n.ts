...
const en: Dictionary = {
  ...
  "rules.title": "Rules",
  "rules.subtitle": "Automate VIGIL from external events.",
  ...
  "rules.form.error.noTrigger": "Pick a trigger",
  "rules.form.error.noReaction": "Pick a reaction",
  "rules.form.error.badFilters": "Filters must be valid JSON",
  ...
  "services.tokenPlaceholder": "Paste your personal token or webhook URL",
